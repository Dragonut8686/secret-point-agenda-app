...
// supabase/functions/register_user_secretpoint/index.ts
...
serve(async (req) => {
  ...
  try {
    ...
    const botToken = Deno.env.get('BOT_TOKEN_SECRETPOINT')!
    ...
    console.error('Error in register_user_secretpoint function:', err)
    return new Response(
